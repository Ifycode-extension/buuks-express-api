...
const getBooksForEachUserController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const docs = yield (0, book_service_1.getBooksService)({ user: userId });
        // console.log(docs);
        ...
        return res.status(200).json({
            count: docs.length,
            description: `List of books uploaded by user: ${user === null || user === void 0 ? void 0 : user.name}, user ID: ${user === null || user === void 0 ? void 0 : user._id}`,
            books: docs.map(doc => {
                return {
                    _id: doc._id,
                    title: doc.title,
...
const updateBookController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updateBook = (body) => __awaiter(void 0, void 0, void 0, function* () {
            const doc = yield (0, book_service_1.updateBookservice)(bookId, body, { new: true });
            let dbvalues = [{ title: doc === null || doc === void 0 ? void 0 : doc.title, description: doc === null || doc === void 0 ? void 0 : doc.description }, { title: doc === null || doc === void 0 ? void 0 : doc.title }, { description: doc === null || doc === void 0 ? void 0 : doc.description }];
            ...
            res.status(200).json({
                ...
                book: {
                    ...
                    pdf: doc === null || doc === void 0 ? void 0 : doc.pdf,
                    request: {
                        type: 'GET',
