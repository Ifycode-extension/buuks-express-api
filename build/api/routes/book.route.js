...
router.get('/user/:userId', requireUser_1.default, book_controller_1.getBooksForEachUserController);
router.get('/:bookId', (0, validate_1.default)(book_schema_1.getOneBookSchema), book_controller_1.getOneBookController);
router.put('/:bookId', requireUser_1.default, multer_1.multerUploadsMiddleware, book_controller_1.updateBookController);
