...
exports.findUserService = exports.validatePasswordService = exports.createUserService = exports.checkExistingUserService = void 0;
const lodash_1 = require("lodash");
const user_model_1 = require("../models/user.model");
const checkExistingUserService = ({ email, password, name }) => __awaiter(void 0, void 0, void 0, function* () {
    const existingUser = yield user_model_1.UserModel.findOne({ email });
    return existingUser;
});
exports.checkExistingUserService = checkExistingUserService;
const createUserService = ({ email, password, name }) => __awaiter(void 0, void 0, void 0, function* () {
    const query = yield user_model_1.UserModel.create({
        email,
        password,
        name
    });
