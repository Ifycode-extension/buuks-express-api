...
const getBooksService = (filter) => __awaiter(void 0, void 0, void 0, function* () {
    const query = yield book_model_1.BookModel.find(filter).sort('-createdAt');
    return query;
});
...
const createBookService = (input /*DocumentDefinition<Omit<BookDocument, 'createdAt' | 'updatedAt'>>*/) => __awaiter(void 0, void 0, void 0, function* () {
